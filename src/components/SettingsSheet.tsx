    ...
    <AnimatePresence>
      ...
      <>
          ...
          className="fixed bottom-0 left-0 right-0 z-50 max-w-[430px] mx-auto">
            ...
            <div className="glass-strong rounded-t-3xl px-5 pt-3 pb-8 safe-bottom max-h-[85dvh] flex flex-col">
              {/* Handle */}
                          ...
                          <div className="glass rounded-2xl p-4">
                            <div className="flex items-start gap-3">
                              ...
                              <p className="text-xs text-muted-foreground leading-relaxed">
                                Silo works completely offline — even in airplane mode. Your recordings never leave your device, and we never request network access.  All of the AI features are baked in (that's why it took so long to download).                                                            
...
}: {icon: React.ReactNode;label: string;labelClassName?: string;trailing?: React.ReactNode;}) =>
